...
namespace TestSecureAuthSvc.SecureAuthMembershipSvc {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipCreateStatus))]
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SecureAuthMembershipSvc.IMembership")]
    public interface IMembership {
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipCreateStatus))]
        TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserResponse CreateUser(TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMembership/CreateUser", ReplyAction="http://tempuri.org/IMembership/CreateUserResponse")]
        System.Threading.Tasks.Task<TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserResponse> CreateUserAsync(TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserRequest request);
        ...
        TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel GetUser(string adminUserName, string adminPassword, string userId, bool isOnline);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMembership/GetUser", ReplyAction="http://tempuri.org/IMembership/GetUserResponse")]
        System.Threading.Tasks.Task<TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel> GetUserAsync(string adminUserName, string adminPassword, string userId, bool isOnline);
    ...
    public partial class CreateUserResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://tempuri.org/", Order=0)]
        public TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel CreateUserResult;
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://tempuri.org/", Order=1)]
        public TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipCreateStatus status;
        
        public CreateUserResponse() {
        }
        
        public CreateUserResponse(TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel CreateUserResult, TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipCreateStatus status) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMembershipChannel : TestSecureAuthSvc.SecureAuthMembershipSvc.IMembership, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MembershipClient : System.ServiceModel.ClientBase<TestSecureAuthSvc.SecureAuthMembershipSvc.IMembership>, TestSecureAuthSvc.SecureAuthMembershipSvc.IMembership {
        ...
        TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserResponse TestSecureAuthSvc.SecureAuthMembershipSvc.IMembership.CreateUser(TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserRequest request) {
            return base.Channel.CreateUser(request);
        }
        
        public TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel CreateUser(string adminUserName, string adminPassword, string userId, string userPassword, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipCreateStatus status) {
            TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserRequest inValue = new TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserRequest();
            ...
            TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserResponse retVal = ((TestSecureAuthSvc.SecureAuthMembershipSvc.IMembership)(this)).CreateUser(inValue);
            status = retVal.status;
            return retVal.CreateUserResult;
        }
        
        public System.Threading.Tasks.Task<TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserResponse> CreateUserAsync(TestSecureAuthSvc.SecureAuthMembershipSvc.CreateUserRequest request) {
            return base.Channel.CreateUserAsync(request);
        }
        
        public TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel GetUser(string adminUserName, string adminPassword, string userId, bool isOnline) {
            return base.Channel.GetUser(adminUserName, adminPassword, userId, isOnline);
        }
        
        public System.Threading.Tasks.Task<TestSecureAuthSvc.SecureAuthMembershipSvc.MembershipUserModel> GetUserAsync(string adminUserName, string adminPassword, string userId, bool isOnline) {
